                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-cyan-300 focus:outline-none focus:border-emerald-500"
                          >
